        ...
        lg:px-16 md:px-12 sm:px-8'>
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    <motion.a href="mailto:geudens.steven@outlook.com" target={"_blank"}
                              whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3 fill-dark dark:fill-light">
                        <MailIcon/>
                    </motion.a>
                ...
                isOpen ?
                    ...
                    initial={{scale:0, opacity:0, x:"-50%", y:"-50%"}} animate={{scale:1, opacity:1}}>
                        ...
                        <nav className="flex items-center justify-center flex-wrap mt-2">
                            ...
                            <motion.a href="mailto:geudens.steven@outlook.com" target={"_blank"}
                                      whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3 sm:mx-1 fill-light dark:fill-dark">
                                <MailIcon/>
                            </motion.a>
                            <button onClick={() => setMode(mode === "light" ? "dark" : "light")}
                                    className={`ml-3 sm:ml-1 flex items-center justify-center rounded-full p-1 
                                    ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}`}>
                                {mode === "dark" ? <SunIcon className="fill-dark w-[24px] h-[24px]"/> : <MoonIcon className="fill-dark w-[24px] h-[24px]"/>}
                            </button>
                        </nav>
                    </motion.div>
                    : null
