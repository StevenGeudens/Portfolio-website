...
const HireMe = () => {
    return (
        ...
        md:bottom-auto md:absolute sm:right-0 z-10">
            <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
                ...
                hover:dark:text-light hover:dark:border-light md:w-12 md:h-12 md:text-[10px] text-center leading-5 md:leading-3 pt-2 md:pt-1">Contact Me</Link>
            </div>
        </div>
    )
}
